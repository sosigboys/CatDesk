...
CatDesk — мой проект, который может вырости в полноценный продукт. Началось с того, что надоели лимиты RuDesktop (2 часа и отключение + ctrcctrlv с RustDesk только со своим серваком), а AnyDesk банят в РФ.
